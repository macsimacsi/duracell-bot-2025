...
class BannersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post banners_url, params: { banner: { active: @banner.active, link: @banner.link, position: @banner.position } }
    end
  ...
  test "should update banner" do
    patch banner_url(@banner), params: { banner: { active: @banner.active, link: @banner.link, position: @banner.position } }
