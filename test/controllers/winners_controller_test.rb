...
class WinnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create winner" do
    assert_difference('Winner.count') do
      post winners_url, params: { winner: { gas_stations_detail_id: @winner.gas_stations_detail_id, participation_id: @winner.participation_id, status: @winner.status } }
    end
  ...
  test "should update winner" do
    patch winner_url(@winner), params: { winner: { gas_stations_detail_id: @winner.gas_stations_detail_id, participation_id: @winner.participation_id, status: @winner.status } }
