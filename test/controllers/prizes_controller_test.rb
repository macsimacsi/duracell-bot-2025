...
class PrizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prize" do
    assert_difference('Prize.count') do
      post prizes_url, params: { prize: { active: @prize.active, name: @prize.name, quantity: @prize.quantity } }
    end
  ...
  test "should update prize" do
    patch prize_url(@prize), params: { prize: { active: @prize.active, name: @prize.name, quantity: @prize.quantity } }
